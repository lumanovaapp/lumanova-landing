...
const testimonials = [
  {
    ...
    quote: "Day 30. Already feel different.",
    subtext: "Used to avoid mirrors. Now I check twice.",
  },
  {
    initial: "A.",
    flag: "🇱🇰",
    gradient: "from-[#7FE0D3] to-[#0E3A47]",
    quote: "First app that gets my features.",
    subtext: "Stopped comparing myself to Western standards.",
  },
  {
    initial: "K.",
    flag: "🇧🇩",
    gradient: "from-[#8b5cf6] to-[#F4C430]",
    quote: "Finally a coach, not a critic.",
    subtext: "The weekly plans are actually doable.",
  },
  {
    initial: "R.",
    flag: "🇺🇸",
    gradient: "from-[#F4C430] to-[#7FE0D3]",
    quote: "My jawline is sharper than ever.",
    subtext: "3 months in. Zero regrets.",
  },
];
